<template>
    <div id="reimbursement">
           <div class="title">
             <span class="title-bill">编辑报销单:</span>
           </div>
             ...
             <div class="detailed-title">
               ...
               <el-dropdown @command="handleCommand"  size="small">
                  <span class="el-dropdown-link" >
                    明细列表<i class="el-icon-arrow-down el-icon--right"></i>
                  </span>
      ...
      <span class="value" style="font-size: 16px;">{{fullMoney}}</span>
            ...
            <div class="detailed-all" >
              ...
              <div class="detailed-all-content-bottom">
                <el-checkbox  v-for="(content,index) in cities" :key="index">
    ...
    export default {
      ...
      //  添加明细
        ...
        addButtonhidden(ruleForms){
          ...
          console.log(ruleForms.selectDefault)
