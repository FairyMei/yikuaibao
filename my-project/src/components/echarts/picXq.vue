...
<!--查看数据的弹框-->
    <div class="dalog"><el-dialog title="查看数据" :visible.sync="dialogTableVisible" width="60%">
      <el-input size="small" placeholder="搜索标题、单号或提交人" suffix-icon="el-icon-search" v-model="input"></el-input>
      <el-table :border="true" :data="gridData" :default-sort = "{prop: 'date', order: 'descending'}" @selection-change="hanChange" @select="selec2" @select-all="selec1">
      ...
      <div class="footer">
        <el-row>
          <el-col :span="3"><div class="grid-content bg-purple">
            <el-button plain :disabled="disas" size="small">导出全部</el-button>
          </div></el-col>
          <el-col :span="3"><div class="grid-content bg-purple-light">
            <el-button plain :disabled="disas" size="small">导出选中</el-button>
          </div></el-col>
          <el-col :span="10"><div class="grid-content bg-purple">
            <span>已选择</span><span>{{messge}}</span><span>张</span>
          </div></el-col>
